...
const BrandsSlider = () => {
  ...
  const brandItems = [
    { id: 1, img: '/img/brand-1.svg', alt: 'brand-1' },
    { id: 2, img: '/img/brand-2.svg', alt: 'brand-3' },
    { id: 3, img: '/img/brand-3.svg', alt: 'brand-2' },
    { id: 4, img: '/img/brand-4.svg', alt: 'brand-4' },
    { id: 5, img: '/img/brand-5.png', alt: 'brand-1' },
    { id: 6, img: '/img/brand-3.svg', alt: 'brand-3' },
    { id: 7, img: '/img/brand-2.svg', alt: 'brand-2' },
    { id: 8, img: '/img/brand-1.svg', alt: 'brand-1' },
    { id: 9, img: '/img/brand-3.svg', alt: 'brand-3' },
